  ...
  return (
    <div>
      <button
        ...
        className="relative rounded-md bg-gray-950/5 px-3 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-950/10 flex items-center gap-2"
      >
                  ...
                  <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="mt-6">
                      <button
                        ...
                        className="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-xs hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
                      >
